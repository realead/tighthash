...
class MapTester(unittest.TestCase):
    ...
    def template_insert_no_realoc(self,test_class):
        s=test_class(10)
    ...
    def template_insert_no_realoc_with_zero(self,test_class):
        s=test_class(11)
    ...
    def template_not_in(self,test_class):
        s=test_class(11)
        for x in xrange(0,11):
    ...
    def template_insert_with_realoc(self,test_class):
        s=test_class(4)
        for x in xrange(10):
            s[x]=x       
        self.assertEquals(len(s), 10)
    ...
    def template_get_item_zero(self,test_class):
        s=test_class(4)
        s[0]=100 
    ...
    def template_get_item_zero_throws(self,test_class):
        s=test_class(4)
    ...
    def template_get_item_nonzero(self,test_class):
        s=test_class(4)
    ...
    def template_get_item_nonzero_throws(self,test_class):
        s=test_class(4)
        for x in xrange(1,10):
            s[x]=x+22
        self.assertEquals(len(s), 9)
    ...
    def template_delitem(self, test_class):
        s=test_class(10)
        for x in xrange(1,11):
          s[x]=x+44
          self.assertTrue(x in s)
    ...
    def template_delitem_zero(self, test_class):
        s=test_class(10)
        s[0]=0
        self.assertTrue(0 in s)
        del s[0]
    ...
    def template_delitem_zero_throws(self, test_class):
        s=test_class(4)
        with self.assertRaises(KeyError) as context:
             del s[0]
        self.assertEquals(0, context.exception.args[0])     
        
    def template_delitem_throws(self, test_class):
        s=test_class(4)
        for x in xrange(1,11):
          s[x]=x+44
          self.assertTrue(x in s)
    ...
    def template_overwrite_item_no_relocation(self, test_class):
        s=test_class(1)
